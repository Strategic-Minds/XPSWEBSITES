        ...
        input: [
          {
            ...
            content: [
              {
                type: "input_text",
                text: `Search the web for visual examples related to: ${command || "white swirl epoxy floor"}. Return exactly three epoxy floor style options. Use direct image URLs only when available; otherwise leave imageUrl empty and include sourceUrl.`
              }
            ]
          }
        ],
